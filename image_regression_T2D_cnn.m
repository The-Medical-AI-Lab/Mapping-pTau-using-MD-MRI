...
load("dataset/regression_image_data_T2D.mat", 'X', 'y');  % X: 50x50x1xN, y: N×1
...
grid on;
saveas(gcf, 'image/cnn regression/performance_crossvalidation_T2D.png');
...
saveas(gcf, 'image/cnn regression/reconstruction_cnn_T2D.png');
