...
sgtitle('5-Fold CV Performance Metrics for T2D under PCA');
saveas(fig, 'image/classification binary/performance_crossvalidation_T2D_pca_tuning.png');
...
for m = 1:numel(fields)
    ...
    fname = sprintf('image/classification binary/reconstruction_%s_T2D_pca_tuning.png', lower(models{m}));
    saveas(gcf, fname);
end
