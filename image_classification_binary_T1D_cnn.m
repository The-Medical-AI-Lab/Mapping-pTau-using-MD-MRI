...
load("dataset/classification_image_data_T1D_binary.mat");  % X: 50x50x1xN, yBinary: N×1
y = yBinary;
...
saveas(gcf, 'image/cnn classification/performance_cv_cnn_binary_T1D.png');
...
saveas(gcf, 'image/cnn classification/reconstruction_cnn_binary_T1D.png');
