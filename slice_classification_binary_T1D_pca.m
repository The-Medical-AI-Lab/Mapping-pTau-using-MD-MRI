...
sgtitle('Slicewise CV Performance Metrics for T1D under PCA');
saveas(fig, 'image/slicewise classification binary/performance_slice_cv_T1D_pca.png');
...
for m = 1:numel(fields)
    ...
    fname = sprintf('image/slicewise classification binary/reconstruction_%s_T1D_pca.png', lower(models{m}));
    saveas(gcf, fname);
end
