...
load("dataset/regression_data_T1D.mat");  % X and y
...
sgtitle('5-Fold CV Regression Performance of T1D');
saveas(fig, 'image/slicewise regression/slicewise_performance_crossvalidation_T1D_pca.png');
...
for m = 1:numel(fields)
    ...
    fname = sprintf('image/slicewise regression/slicewise_reconstruction_%s_T1D_pca.png', lower(models{m}));
    saveas(gcf, fname);
end
