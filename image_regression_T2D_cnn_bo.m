...
load("dataset/regression_image_data_T2D.mat", 'X', 'y'); % X: 50x50x1xN images, y: Nx1 regression targets
...
saveas(gcf, 'image/cnn regression/performance_crossvalidation_T2D_BO.png');
...
saveas(gcf, 'image/cnn regression/reconstruction_cnn_T2D_BO.png');
