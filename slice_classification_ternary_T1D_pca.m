...
load("dataset/classification_data_T1D_ternary.mat");  % X and yContinuous
...
sgtitle('Slicewise CV Performance Metrics for T1D (Ternary) under PCA');
saveas(fig, 'image/slicewise classification ternary/performance_slicewise_cv_T1D_ternary_pca.png');
...
for m = 1:numel(fields)
    ...
    fname = sprintf('image/slicewise classification ternary/reconstruction_%s_T1D_ternary_pca.png', lower(models{m}));
    saveas(gcf, fname);
end
