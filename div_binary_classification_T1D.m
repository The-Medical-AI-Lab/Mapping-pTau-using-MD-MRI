...
for c = 1:C
    ...
    sgtitle('Average T1-MD Joint Distributions and Difference', 'FontName', 'Arial');
    
    set(gcf, 'PaperPositionMode', 'auto');
    outFile = fullfile(saveDir, 'PsiT1D_Average_binary.png');
...
% Save
targetFile = "dataset/classification_image_data_T1D_binary.mat";
save(targetFile, 'KLD', 'JSD', '-append');
fprintf('Variables KLD and JSD have been appended to:\n%s\n', targetFile);
info = whos('-file', targetFile);
disp({info.name}');

targetFile = "dataset/classification_data_T1D_binary.mat";
save(targetFile, 'KLD', 'JSD', '-append');
fprintf('Variables KLD and JSD have been appended to:\n%s\n', targetFile);
info = whos('-file', targetFile);
disp({info.name}');
...
print(fig1, fullfile(outDir,'Boxplot_JSD_Margin_T1D.png'), '-dpng','-r600');
...
print(fig2, fullfile(outDir,'Boxplot_KLD_Margin_T1D.png'), '-dpng','-r600');
